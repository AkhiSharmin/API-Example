...
const displayMeals = meals => {
    // console.log(meals);
    // step-1 want to container element 
    const mealsContainer = document.getElementById('meals-container');
    mealsContainer.innerHTML = '';
    meals.forEach(meals => {
        console.log(meals);
        //step-2 create child forEach element
        ...
        <div class="card-body">
            ...
            <button onclick ="loadMealDetail2(${meals.idMeal})" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#mealsDetails">
            Details
            </button>
        </div>
    </div>
